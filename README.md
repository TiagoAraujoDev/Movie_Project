<h1 align="center">MovieFinder</h1>
...
- In this project my main goal was to make an application that you could find all your favorite movies and save them as favorite.
- To make it come true I used The Movie Database, a famous API to get movies information like title, poster, description and much more.
- About the feature that lets you save your favorite movies, I used localstorage. 
